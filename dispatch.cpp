...
#define POROTO(m) \
        ...
        case EXCEPTION_ACCESS_VIOLATION:
          POROTO("EXCEPTION_ACCESS_VIOLATION");
        case EXCEPTION_ARRAY_BOUNDS_EXCEEDED:
          POROTO("EXCEPTION_ARRAY_BOUNDS_EXCEEDED");
        case EXCEPTION_BREAKPOINT:
          POROTO("EXCEPTION_BREAKPOINT");
        case EXCEPTION_DATATYPE_MISALIGNMENT:
          POROTO("EXCEPTION_DATATYPE_MISALIGNMENT");
        case EXCEPTION_FLT_DENORMAL_OPERAND:
          POROTO("EXCEPTION_FLT_DENORMAL_OPERAND");
        case EXCEPTION_FLT_DIVIDE_BY_ZERO:
          POROTO("EXCEPTION_FLT_DIVIDE_BY_ZERO");
        case EXCEPTION_FLT_INEXACT_RESULT:
          POROTO("EXCEPTION_FLT_INEXACT_RESULT");
        case EXCEPTION_FLT_INVALID_OPERATION:
          POROTO("EXCEPTION_FLT_INVALID_OPERATION");
        case EXCEPTION_FLT_OVERFLOW:
          POROTO("EXCEPTION_FLT_OVERFLOW");
        case EXCEPTION_FLT_STACK_CHECK:
          POROTO("EXCEPTION_FLT_STACK_CHECK");
        case EXCEPTION_FLT_UNDERFLOW:
          POROTO("EXCEPTION_FLT_UNDERFLOW");
        case EXCEPTION_ILLEGAL_INSTRUCTION:
          POROTO("EXCEPTION_ILLEGAL_INSTRUCTION");
        case EXCEPTION_IN_PAGE_ERROR:
          POROTO("EXCEPTION_IN_PAGE_ERROR");
        case EXCEPTION_INT_DIVIDE_BY_ZERO:
          POROTO("EXCEPTION_INT_DIVIDE_BY_ZERO");
        case EXCEPTION_INT_OVERFLOW:
          POROTO("EXCEPTION_INT_OVERFLOW");
        case EXCEPTION_INVALID_DISPOSITION:
          POROTO("EXCEPTION_INVALID_DISPOSITION");
        case EXCEPTION_NONCONTINUABLE_EXCEPTION:
          POROTO("EXCEPTION_NONCONTINUABLE_EXCEPTION");
        case EXCEPTION_PRIV_INSTRUCTION:
          POROTO("EXCEPTION_PRIV_INSTRUCTION");
        case EXCEPTION_SINGLE_STEP:
          POROTO("EXCEPTION_SINGLE_STEP");
        case EXCEPTION_STACK_OVERFLOW:
          POROTO("EXCEPTION_STACK_OVERFLOW");
        default:
          {
            TCHAR*  pDesc;
            // obtiene el mensaje
